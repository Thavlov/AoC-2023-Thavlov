...
class Day03Test {
    ...
    void testPart1Solution() throws Exception {
        ...
        if (RUN_EXAMPLE) {
            assertThat(part1Solution).isEqualTo("4361");
        } else {
            assertThat(part1Solution).isEqualTo("539637");
        }
    }
    ...
    void testPart2Solution() throws Exception {
        ...
        if (RUN_EXAMPLE) {
            assertThat(part2Solution).isEqualTo("467835");
        } else {
            assertThat(part2Solution).isEqualTo("82818007");
        }
    }
}