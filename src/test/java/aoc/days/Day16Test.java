...
class Day16Test {
    ...
    void testPart1Solution() throws Exception {
        ...
        if (RUN_EXAMPLE) {
            assertThat(part1Solution).isEqualTo("46");
        } else {
            assertThat(part1Solution).isEqualTo("8116");
        }
    }
    ...
    void testPart2Solution() throws Exception {
        ...
        if (RUN_EXAMPLE) {
            assertThat(part2Solution).isEqualTo("51");
        } else {
            assertThat(part2Solution).isEqualTo("8383");
        }
    }
}