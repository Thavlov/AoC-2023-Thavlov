...
class Day17Test {
    ...
    void testPart1Solution() throws Exception {
        ...
        if (RUN_EXAMPLE) {
            assertThat(part1Solution).isEqualTo("102");
        } else {
            assertThat(part1Solution).isEqualTo("953");
        }
    }
    ...
    void testPart2Solution() throws Exception {
        ...
        if (RUN_EXAMPLE) {
            assertThat(part2Solution).isEqualTo("94");
        } else {
            assertThat(part2Solution).isEqualTo("1180");
        }
    }
}